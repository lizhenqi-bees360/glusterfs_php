...
class Login extends CI_Controller {
	...
	{
		if ($this->m_user->is_logged_in()) { redirect('home'); }//go to homepage
	...
	public function register() {
		// if ($this->m_user->is_logged_in()) { redirect('home'); }

		$this->form_validation->set_rules('role', 'Full Name', 'required');
